...
public class SpaAsyncTask extends AsyncTask<String, Void, String> {
    ...
    public SpaAsyncTask(Context context, String msg, String total){
    ...
    protected void onPostExecute(String s) {
        ...
        if(result.equals("The selected slot is not available")){
